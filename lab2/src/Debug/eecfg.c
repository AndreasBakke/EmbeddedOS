 ...
 **************************************************************************/
    ...
    static EE_STACK_T EE_STACK_ATTRIB EE_stack_1[EE_STACK_WLEN(STACK_1_SIZE)];	/* Task 0 (SenderTask) */
    static EE_STACK_T EE_STACK_ATTRIB EE_stack_2[EE_STACK_WLEN(STACK_2_SIZE)];	/* irq stack */
    ...
    struct EE_TOS EE_e200z7_system_tos[EE_E200Z7_SYSTEM_TOS_SIZE] = {
        {0},	/* Task  (dummy) */
        {(EE_ADDR)(&EE_stack_1[EE_STACK_INITP(STACK_1_SIZE)])} 	/* Task 0 (SenderTask) */
    };
    ...
    struct EE_TOS EE_e200z7_IRQ_tos = {
        (EE_ADDR)(&EE_stack_2[EE_STACK_INITP(STACK_2_SIZE)])
    };
 ...
 **************************************************************************/
    ...
    const EE_THREAD_PTR EE_hal_thread_body[EE_MAX_TASK] = {
        &EE_oo_thread_stub 		 /* thread SenderTask */
    ...
    /* The pairs that are enqueued into the priority queues (1 is the total number of task activations) */
 ...
 **************************************************************************/
    const EE_oo_action_ROM_type   EE_oo_action_ROM[EE_ACTION_ROM_SIZE] = {
        ...
        {EE_ACTION_EVENT   , SenderTask, TimerEvent1, (EE_VOID_CALLBACK)NULL, (EE_TYPECOUNTER)-1 }
    };
